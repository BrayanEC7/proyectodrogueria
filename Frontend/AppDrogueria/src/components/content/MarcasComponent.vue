	...
	<div class="right_col" role="main">
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel" id="tabladatosmarcas" v-show="!mostrarformulario">
					<div class="x_title">
						<h2>Registro de Marcas <small>listado</small></h2>
						...
						<div class="row">
							<div class="col-sm-12 input-group mb-3">
								<input type="text" id="searchnombre" name="searchnombre" v-model="searchnombre"
									...
									placeholder="Buscar por nombre de Marcas">
									...
									<table id="datatable-fixed-header" class="table table-striped table-bordered"
										...
										<tbody>
											<tr v-for="itemMarca in listamarcas">
												<td>{{ itemMarca.nombreMarca }}</td>
												<td class="text-center">
													<i class="fa fa-pencil" v-on:click="editarMarca(itemMarca)"
														style="cursor:pointer; padding-right: 1ex; color: burlywood;"></i>
													<i class="fa fa-trash" v-on:click="eliminarMarca(itemMarca.id)"
				...
				<div class="x_panel" id="formulariomarcas" v-show="mostrarformulario">
					<div class="x_title">
						<h2>Registro de Marcas <small>editar/crear</small></h2>
						<ul class="nav navbar-right panel_toolbox">
							<li><a class="collapse-link">
									<i class="fa fa-chevron-up"></i></a>
							</li>
					...
					<div class="x_content">
						<br />
						<form id="frmMarca" v-on:submit="guardardatos()" data-parsley-validate
							class="form-horizontal form-label-left">
							<input type="hidden" id="id" name="id" v-model="id" />
							<div class="item form-group">
								<label class="col-form-label col-md-3 col-sm-3 label-align" for="nombreMarca">Nombre de
									Presentación <span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 ">
									<input type="text" id="nombreMarca" name="nombreMarca" v-model="nombreMarca" required
										class="form-control ">
								</div>
							</div>
...
export default {
	...
	methods: {
		async iniciarCarga() {
			try {
				var urltmp = "http://localhost:8080/v1/marca/buscarBy/" + this.searchnombre;
				if (this.searchnombre == "") urltmp = urltmp = "http://localhost:8080/v1/marca/";
		...
		guardardatos() {
			...
			fetch("http://localhost:8080/v1/marca/", {
		...
		eliminarMarca(idtmp) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					fetch("http://localhost:8080/v1/marca/" + idtmp, {
